...
raw_data <- read.csv(file="data//All02.csv", header=TRUE, sep=",")
summary(raw_data)
...
write.csv(cv_pc, 'data\\B5glmnet_randomforest_pc.csv', row.names=F)
write.csv(cv_td, 'data\\B5glmnet_randomforest_td.csv', row.names=F)
